...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--attention_embedding_size", type=int, default=256, help="hidden size of attention output vector"
    )
    ...
    parser.add_argument("--attention_mechanism", default="align", type=str, help="Intent-Slot attention mechanism")
    parser.add_argument("--optimizer", default="adam", type=str, help="Training optimizer")
    parser.add_argument("--scheduler", default="linearwa", type=str, help="Training optimizer")
    parser.add_argument("--num_heads", default=1, type=int, help="MHSA heads")
    parser.add_argument("--verbose", action="store_true", help="Print evaluations")
